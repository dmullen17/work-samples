...
drop table if exists acquired_unlimited_spend_conversion_country;
create table acquired_unlimited_spend_conversion_country (
      country varchar 
...
insert into acquired_unlimited_spend_conversion_country ( 
    Select 
          country 
...
drop table if exists acquired_unlimited_spend_conversion;
create table acquired_unlimited_spend_conversion (
      country varchar 
     ,lifetime_28_day_bucket int
     ,engagement_status_total varchar  
     ,deployment decimal(3,2)   
...
insert into acquired_unlimited_spend_conversion ( 
    Select 
          'Total' as country 
         ,lifetime_28_day_bucket 
         ,engagement_status_total 
...
drop table if exists acquired_unlimited_spend_conversion_main;
create table acquired_unlimited_spend_conversion_main (
      country varchar 
     ,lifetime_28_day_bucket int
     ,engagement_status_total varchar  
     ,deployment decimal(3,2)   
...
insert into acquired_unlimited_spend_conversion_main ( 
  Select 
        a.country 
       ,a.lifetime_28_day_bucket
       ,a.engagement_status_total 
      ...
      From acquired_unlimited_spend_conversion a 
      Join acquired_unlimited_spend_conversion b 
...
Union
  Select 
       ...
       ,b.User_Count Non_Spender_Count
       ,(100.00 * a.User_Count / (a.User_Count + b.User_Count)) Spender_Conversion
      From acquired_unlimited_spend_conversion_country a 
      Join acquired_unlimited_spend_conversion_country b 
        on a.country = b.country 
        and a.lifetime_28_day_bucket = b.lifetime_28_day_bucket
        and a.engagement_status_total= b.engagement_status_total
        and a.deployment= b.deployment
